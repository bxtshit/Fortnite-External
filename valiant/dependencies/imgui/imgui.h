...
struct ImGuiKeyData;                // Storage for ImGuiIO and is_down(), IsKeyPressed() etc functions.
...
namespace ImGui
{
    ...
    IMGUI_API bool          is_down(ImGuiKey key);                                            // is key being held.
...
// [Internal] Storage used by is_down(), IsKeyPressed() etc functions.
